...
document.getElementById("firstBtn").addEventListener("click", function () {
  ...
  if (inputAmount > mainBlance) {
    ...
    document.getElementById("NoakhaliAdd").innerText =
      inputAmount + NoakhaliAddn;
    ...
    if (inputAmount > 0) {
      ...
      div.innerHTML = `
            <div id="CRdiV" class="border p-2 rounded mt-3 text-green-500"> 
                <h1>${inputAmount} Taka is Donated for famine-2024 at Feni, Bangladesh total donated taka ${
        inputAmount + NoakhaliAddn
      } <br> ${xx}</h1>
...
document.getElementById("secondBtn").addEventListener("click", function () {
  ...
  if (secondInputAmountF > mainBlance) {
    ...
    document.getElementById("SecondFund").innerText =
      secondInputAmountF + secondFundAdd;
    ...
    if (secondInputAmountF > 0) {
      ...
      div.innerHTML = `
            <div class="border p-2 rounded mt-3 text-indigo-500"> 
                <h1>${secondInputAmountF} Taka is Donated for Flood Relief in Feni,Bangladesh total donated taka ${
        secondInputAmountF + secondFundAdd
      } <br> ${xx}</h1>
            </div>
            `;
...
document.getElementById("thirdBtn").addEventListener("click", function () {
  ...
  if (thirdInputnum > mainBlance) {
    ...
    document.getElementById("thirdFund").innerText =
      thirdInputnum + thirdFundNum;
    ...
    if (thirdInputnum > 0) {
      ...
      div.innerHTML = `
            <div class="border p-2 rounded mt-3 text-fuchsia-500"> 
                <h1>${thirdInputnum} Taka is Donated for Aid for Injured in the Quota Movement, Bangladesh total donated taka ${
        thirdInputnum + thirdFundNum
      } <br> ${xx}</h1>
            </div>
            `;
...
function hideAndShowzx(id) {
  if (document.getElementById(id).classList.contains("bg-white") === true) {
    ...
    document.getElementById(id).classList.contains("bg-pink-50") === true
  ) {
